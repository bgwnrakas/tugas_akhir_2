...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <a type="button" class="btn btn-success" href="<?= base_url('hrd/edit_profile'); ?>">Edit Profile</a>
            ...
            <div class="card mb-3" style="max-width: 1000px;">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="<?= base_url('assets/img/profile/') . $user['image']; ?>" width="30" height="320" class="card-img">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
